  ...
  return (
    ...
    >
      <div className="heroSectionBg relative z-[100] h-screen">
        ...
        />
        <div className="heroSectionAfterDisplay absolute right-[55px] top-[70px] h-[15px] w-[62px] cursor-pointer border-y-[1.5px] border-black opacity-0 xl:h-[18.5px] xl:w-[76px]"></div>
        <div
          id="heroSectionTextContainer"
          className={`${layGrotesk.className} absolute bottom-[15px] left-[16px] translate-y-[7px] text-[92px] leading-[84px] text-heroSectionTextColor xl:text-[128px] xl:leading-[120px]`}
        ></div>
        <Image
          src={"/workSticker.svg"}
          ...
          width={127}
          height={127}
          className="heroSectionAfterDisplay absolute bottom-[69px] right-[68px] aspect-square w-[98px] opacity-0 xl:w-[127px]"
        />
      </div>
      {heroSectionEnd && (
        <>
                ...
                <div className="flex flex-col gap-y-[16px] text-nowrap text-center uppercase xl:gap-y-[18px]">
                  <div className="overflow-hidden">
                    <p
                      ...
                      className={`${offBit.className} thirdMaskText text-[22px] leading-none tracking-[0.06em] xl:text-[32px]`}
                    >
                  ...
                  <div className="overflow-hidden">
                    <p
                      ...
                      className={`${layGrotesk.className} firstMaskText text-[96px] font-semibold leading-none tracking-[0.02em] xl:text-[128px]`}
                    >
                  ...
                  <div className="overflow-hidden">
                    ...
                    >
                      <span
                        className={`${layGrotesk.className} text-[96px] font-semibold leading-none tracking-[0.02em] xl:text-[128px]`}
                      >
                        Your{" "}
                      </span>
                      <span
                        style={{ fontStyle: "oblique" }}
                        className={`${maziusReview.className} text-[96px] font-normal leading-none tracking-[0.04em] xl:text-[128px]`}
                      >
                        Vision
                      </span>
                    </p>
